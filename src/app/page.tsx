...
export default function Home() {
    ...
    return (
        <>
            <header className="w-full py-3 px-4 flex items-center justify-between shadow-sm">
                ...
                <div className="text-center flex-1">
                    <h1 className="text-[#123785] text-xl font-semibold">Article 11</h1>
                </div>
                <div className="w-10">
                </div>
            </header>
            ...
            <div className="w-full px-4 mb-20 overflow-hidden">
                <Link href="/forum" className="block mt-4 mb-6">
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-md p-4 relative overflow-hidden">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4 h-16 w-16 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#123785]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                </svg>
                            </div>
                        </div>
                        <div className="absolute top-0 right-0 h-full w-20 opacity-10 bg-contain bg-right bg-no-repeat" ></div>
                    </div>
                </Link>
