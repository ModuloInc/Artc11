        ...
        },
        {
            ...
            icon: (
                <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="12.2284" height="10.6651" rx="3" transform="matrix(-1 0 0 1 28 0)" fill="currentColor"/>
                    <rect width="12.2284" height="10.6651" rx="3" transform="matrix(-1 0 0 1 13.0542 0)" fill="currentColor"/>
                    <rect width="12.2284" height="10.6651" rx="3" transform="matrix(-1 0 0 1 13.0542 13.0347)"
                          fill="currentColor"/>
                    <rect width="12.2284" height="10.6651" rx="3" transform="matrix(-1 0 0 1 28 13.0347)" fill="currentColor"/>
                </svg>
        ...
        <nav
            ...
            {navItems.map((item, index) => (
                <Link
                    key={index}
                    href={item.path}
                    className={`flex flex-col items-center ${isActive(index) ? 'text-[#FFD632]' : 'text-gray-600'}`}
                >
                    {item.icon}
                </Link>
            ))}
